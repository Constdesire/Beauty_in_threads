<!DOCTYPE html>
<html lang="en">
<head><link rel="stylesheet" href="css/mdb.min.css" />
    <!-- Custom styles -->
...
<body class="bg-pink-100">
	<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
		...
		<a class="hidden lg:inline-block py-2 px-6 bg-purple-100 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" href="#">Sign up</a>
	</nav>
