...
<div class="flex items-center justify-center p-12">
    ...
    <h1 class="text-3xl font-semibold mb-6 text-black text-center">Editar Agendamento</h1>
    <p class="my-4 text-center">Atualize as informações do agendamento de serviço no Beleza em fios!</p>
    <form method="POST" action="/editarA/{{$agendamentos ->id}}">
        @csrf
        <div class="form-group">
                <label for="servicos">Serviço</label>
                <select class="custom-select"  name="servicos" value="{{ $agendamentos->Servico }}">
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control"  name="data_servico" value="{{ $agendamentos->DataServico }} ">
            </div>

            <!-- Horário -->
            <div class="form-group">
                <label for="horario">Horário</label>
                <input type="time" class="form-control" name="horario "value="{{ $agendamentos->Horario }}">
            </div>
